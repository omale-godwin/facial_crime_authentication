# Generated by Django 3.0.5 on 2021-08-27 22:01
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lan', models.CharField(blank=True, max_length=200, null=True)),
                ('gen', models.CharField(blank=True, max_length=200, null=True)),
                ('emp_id', models.CharField(default='crm841', max_length=70)),
                ...
                ('joined', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('crime_date', models.CharField(blank=True, max_length=20, null=True)),
                ('crime_type', models.CharField(blank=True, max_length=20, null=True)),
                ('Crime_detail', models.TextField(blank=True, max_length=100, null=True)),
